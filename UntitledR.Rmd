...
selected_columns <- london_boroughs[, c("NAME",
                                        "pri_walk_count",
                                        ...
                                        "sec_walk_bus_mean_accessibility",                                        "Proportion_with_GCSE_grades_A_C_or_equivalent_and_higher")]

for (column in selected_columns) {
  # 绘制直方图
  p <- ggplot(london_boroughs, aes_string(x = column)) +
  ...
  # 绘制箱线图
  p <- ggplot(london_boroughs, aes_string(y = column)) +
