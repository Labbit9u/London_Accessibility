...
ggplot() +
  ...
  labs(title = "Primary School Accessibility by carin London",
       color = "Accessibility") +
  theme_minimal()
```
...
以上对于Public 30分钟 公共交通可达性来说，平均交通可达性最高的三个borough是City of London，Islington，Westminster。（找一下有没有资料显示他们交通很发达之类的）
